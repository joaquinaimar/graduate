    ...
    <TR>
                      ...
                      <TBODY>
                        <TR align=middle>
                          <TD width="770"><DIV class=Xyline align=center>
                              ...
                              <form action="login.do?method=addmgr" method="post" enctype="multipart/form-data" name="addmgr" id="addmgr" onsubmit="return doValidate(this)">
      ...
      style="BORDER-BOTTOM: 1px solid; BORDER-LEFT: 1px solid; BORDER-TOP: 1px solid; BORDER-RIGHT: 1px solid">
                  ...
                  align=right>用户名： </TD>
                                                  ...
                                                  <TR>
                                                    <TD bgColor=#f4f5f7 height=25 align=right>确认密码： </TD>
