                    ...
                    <TABLE border=0 cellSpacing=0 cellPadding=0 width=770>
                      <TBODY>
                        <TR>
                          ...
                          <form action="addstu.do?method=addstu&prtid=${user_id}" method="post" enctype="multipart/form-data" name="addstu" id="addstu" onsubmit="return doValidate(this)">
                ...
                colSpan=4><STRONG>::::学员（请家教）会员的详细资料::::</STRONG></TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD height=25 width=680 align=left><label>
                                        <input type="text" name="firname" id="firname" />
                                      </label></TD>
                                    </TR>
                                    <TR bgColor=#eef0f2>
                                      <TD bgColor=#eef0f2 height=25 width=85 
                  align=left><STRONG>学员性别：</STRONG></TD>
                                      <TD bgColor=#eef0f2 height=25 width=680 align=left><input name="sex" type="radio" id="sex" value="男" checked="checked" />
                                        男
                                        <label>
                  ...
                  align=left><STRONG>学习情况：</STRONG></TD>
                                      <TD bgColor=#eef0f2 height=25 width=680 align=left><label>
                                        <input type="text" name="studyinf" id="studyinf" />
                                      </label></TD>
                                    </TR>
                                    <TR align=left>
                  ...
                  colSpan=4><STRONG>::::教员要求及详细说明::::</STRONG></TD>
                                    ...
                                    <TR>
                                      <TD height=80 colSpan=4><label>
                                        <textarea name="threquire" id="threquire" cols="85" rows="5"></textarea>
                                        </label>
                                      </TD>
                                    </TR>
