...
public class ThrregActionForm extends ActionForm{
	...
	public String getExp_intr() {
		return exp_intr;
	}
	public void setExp_intr(String exp_intr) {
		this.exp_intr = exp_intr;
	}
