...
<script type="text/javascript"
	src="<%=application.getContextPath()%>/script/login.js"></script>
</head>
<body>
	<table width="100%" height="100%" border="0" cellpadding="0"
		cellspacing="0">
		<tr>
			<form id="theform" name="LogFrm" action="controller/login/login.do"
				method="post">
				<td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td height="94" align="center" valign="bottom"
								...
								class="font5">天津君利律师事务所综合信息平台<a href="javascript:void()"
								onClick="showRegisterWindow();">注册</a></td>
						</tr>
					</table>
				</td>
			</form>
